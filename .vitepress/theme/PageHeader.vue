<template>
  <header class="sticky top-0 z-40 w-full backdrop-blur flex-none transition-colors duration-500 lg:z-50 border-b border-c7o-purple/50 supports-backdrop-blur:bg-c7o-night-rider/80">
    <nav class="mx-auto flex max-w-7xl items-center justify-between py-4 px-6">
      <a href="/" class="-m-1.5 p-1.5">
        <span class="sr-only">Crescendo</span>
        <LogoGradient class="h-6"></LogoGradient>
      </a>
    ...
    <ClientOnly>
      <Dialog as="div" class="lg:hidden" @close="mobileMenuOpen = false" :open="mobileMenuOpen">
        ...
        <DialogPanel class="fixed inset-y-0 right-0 z-50 w-full overflow-y-auto bg-c7o-night-rider sm:max-w-sm sm:ring-1 sm:ring-gray-900/10">
          <div class="flex items-center justify-between px-6 py-4 border-b border-c7o-purple/50">
            <div class="flex lg:flex-1" @click="mobileMenuOpen = false">
              <a href="/" class="-m-1.5 p-1.5">
                <span class="sr-only">Crescendo</span>
                <LogoGradient class="text-slate-900 dark:text-slate-900 w-auto h-6"></LogoGradient>
              </a>
            </div>
            <div class="flex lg:hidden">
              <button type="button" class="-m-2.5 inline-flex items-center justify-center rounded-md p-2.5 text-gray-400" @click="mobileMenuOpen = false">
                <span class="sr-only">Close main menu</span>
                <XMarkIcon class="h-6 w-6" aria-hidden="true" />
              </button>
            </div>
          </div>
          <div class="mt-4 flow-root px-6 py-4">
            <div class="-my-6 divide-y divide-gray-500/10">
              <div class="space-y-2 py-2" @click="mobileMenuOpen = false">
              ...
              <div class="py-2" @click="mobileMenuOpen = false">
